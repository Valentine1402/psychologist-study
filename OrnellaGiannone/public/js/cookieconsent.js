...
var cc = {
  ...
  showbanner: function showbanner() {
    ...
    data = '<div id="cc-notification">' + '<div id="cc-notification-wrapper">' + '<h2><span>' + cc.strings.notificationTitle + '</span></h2>' + '<div id="cc-notification-permissions">' + //            '<a id="cc-notification-logo" class="cc-logo" target="_blank" href="http://silktide.com/cookieconsent" title="' + cc.strings.poweredBy + '"><span>' + cc.strings.poweredBy + '</span></a> ' +
    '</div>' + '<ul class="cc-notification-buttons">' + //            '<li>' +
    //            '<a class="cc-link" href="http://cookieconsent.silktide.com" id="cc-approve-button-allsites">' + cc.strings.allowForAllSites + '</a>' +
    //            '</li>' +
    '<li>' + '<a class="cc-link" href="#" id="cc-approve-button-thissite">' + cc.strings.allowCookies + '</a>' + '</li>' + '</ul>' + '<div class="cc-clear"></div>' + '</div>' + '</div>';
...
})( false || navigator.vendor || window.opera);
/**
 * Load web font
 *
 **/
...
/***/ 2:
/*!*********************************************!*\
  !*** multi ./resources/js/cookieconsent.js ***!
  \*********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /Users/valentina/Desktop/MyLaravel/psychologist-study/OrnellaGiannone/resources/js/cookieconsent.js */"./resources/js/cookieconsent.js");
